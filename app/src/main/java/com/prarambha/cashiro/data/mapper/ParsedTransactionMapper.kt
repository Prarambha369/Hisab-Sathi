package com.prarambha.cashiro.data.mapper
...
fun ParsedTransaction.toEntity(): TransactionEntity {
    ...
    val entityType = when (type) {
        ...
        com.prarambha.parser.core.TransactionType.EXPENSE -> TransactionType.EXPENSE
        com.prarambha.parser.core.TransactionType.CREDIT -> TransactionType.CREDIT
        com.prarambha.parser.core.TransactionType.TRANSFER -> TransactionType.TRANSFER
        com.prarambha.parser.core.TransactionType.INVESTMENT -> TransactionType.INVESTMENT
    }
 ...
 */
fun com.prarambha.parser.core.TransactionType.toEntityType(): TransactionType {
    return when (this) {
        com.prarambha.parser.core.TransactionType.INCOME -> TransactionType.INCOME
        com.prarambha.parser.core.TransactionType.EXPENSE -> TransactionType.EXPENSE
        com.prarambha.parser.core.TransactionType.CREDIT -> TransactionType.CREDIT
