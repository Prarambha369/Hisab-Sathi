package com.prarambha.cashiro.presentation.ui.features.categories
...
import com.prarambha.cashiro.presentation.ui.components.CategoryItem
...
import com.prarambha.cashiro.presentation.ui.components.DeleteCategoryDialog
            ...
            EditSubcategorySheet(
                ...
                categoryIconResId = currentCategory?.let { cat ->
                    if (cat.iconName.isNotEmpty()) {
                        com.prarambha.cashiro.utils.IconResolutionUtils.nameToResId(context, cat.iconName)
