package com.prarambha.cashiro.worker
...
import com.prarambha.cashiro.data.mapper.toEntity
import com.prarambha.cashiro.data.mapper.toEntityType
...
import com.prarambha.cashiro.data.repository.MerchantMappingRepository
                        ...
                        try {
                            ...
                            if (rowId != -1L) {
                                ...
                                val targetAccountLast4 = if (isFromCard) {
                                    ...
                                    val result = when {
                                        card.cardType == com.prarambha.cashiro.data.database.entity.CardType.CREDIT -> {
                                            // Credit cards get balance entries
                                            Log.d(TAG, "CREDIT card - will create balance entry")
                                            parsedTransaction.accountLast4
                                        }
                                        card.cardType == com.prarambha.cashiro.data.database.entity.CardType.DEBIT && card.accountLast4 != null -> {
                                ...
                                if (targetAccountLast4 != null) {
                                    ...
                                    val isCreditCard = (parsedTransaction.type.toEntityType() == TransactionType.CREDIT) ||
                                        parsedTransaction.accountLast4?.let {
                                            ...
                                            com.prarambha.cashiro.data.database.entity.CardType.CREDIT
