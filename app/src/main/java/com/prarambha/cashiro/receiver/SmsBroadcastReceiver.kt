...
import com.prarambha.cashiro.CashiroApplication
import com.prarambha.cashiro.R
import com.prarambha.cashiro.data.manager.SmsTransactionProcessor
...
class SmsBroadcastReceiver : BroadcastReceiver() {
    ...
    interface SmsBroadcastReceiverEntryPoint {
        ...
        fun transactionRepository(): com.prarambha.cashiro.data.repository.TransactionRepository
    }
            ...
            try {
                ...
                if (result.success && result.transactionId != null) {
                    ...
                    if (!isAppInForeground(context)) {
                        ...
                        val parser = com.prarambha.parser.core.bank.BankParserFactory.getParser(sender)
    ...
    private fun showTransactionNotification(
        ...
        bankName: String,
        category: String,
        repository: com.prarambha.cashiro.data.repository.TransactionRepository
    ) {
        receiverScope.launch {
            try {
